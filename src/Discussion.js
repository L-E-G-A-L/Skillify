...
import './Discussion.css'; // Import the CSS file
  ...
  return (
    <html lang="en">
      <body className='disbody'>
        <QANav title="Discussions" toggleInnerNav={() => setIsInnerNavVisible(!isInnerNavVisible)} />
...
function InnerNav(){
    return(
        <nav className='disnav'>
          <ul className='disul'>
            <li className='disli'>
              <Link className="link" to="/qastudentdiscussion"><a className='disa'>Student</a></Link>
            </li>
            <li className='disli'>
              <a className='disa' href="#">Instructor</a>
            </li>
            <li className='disli'>
              <a className='disa' href="#">Admin</a>
            </li>
            <li className='disli'>
              <a className='disa' href="#">Program Coordinator</a>
            </li>
          </ul>
        </nav>
    );
