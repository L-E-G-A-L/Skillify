...
function ManageUserPopup({ onClose }) {
  ...
  const onAddHandler = () => {
    ...
    if (
      ...
      else if(userData.password.length < 8) setErrorMessage("Password must be at least 8 characters");
      else if(!isPhoneNumberValid(userData.phoneNumber)) setErrorMessage("Enter a valid phone number");
      ...
      <div className="ManageUser-popup-content">
        {showAddUserForm ? (
          <div className="ManageUser-popup-form">
            ...
            <label className="ManageUser-popup-AddUserInputLabel">Email:</label>
            <input
              type="email"
              id="email"
            name="email"
            ...
            <input
              type="text"
              id="phoneNumber" name="phoneNumber" onChange={e => handleInputChange(e)}
              className="ManageUser-popup-AddUserInput"
            />
            ...
            {error && <h5 className="ManageUser-popup-error-message">{errorMessage}</h5>}
            <div className="ManageUser-popup-ActionBtn">
            <button className="ManageUser-popup-AddUserBtn" onClick={() => onAddHandler(userData)}>Add</button>
            <button className="ManageUser-popup-CancelBtn" onClick={() => toggleUserForm()}>Cancel</button>
            </div>
          </div>
        ) : (
                        ...
                        <div className="permissions-radio-group">
                          <label className="permissions-radio-label">
                            <input
                              ...
                              onChange={() => setEditedUserRole("instructor")}
                            />
                            Instructor
                          </label>
                          <label className="permissions-radio-label">
                        ...
                        <div className="permissions-button-group">
                          ...
                          >
                            ...
                            <div className="admin-user-pop-up-table-action-btns">
                              <button onClick={() => handleEdit(user.user_id, user.role)}>
