...
import './PCChat.css'; // Make sure to import the CSS file
  ...
  return (
    <div className="pc-chat-box">
      ...
      <div className="pc-chat-messages">
        ...
        <div className="message  pc-receiver-message">
          Sure
        </div>
      </div>
      <div className="pc-chat-input">
        <input type="text" placeholder="Type your message..." className='pcchat-input-text'/>
