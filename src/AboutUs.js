    ...
    <div>
      ...
      <section className="abtprg aboutUs-section">
        ...
        <p className="services-p">
          ...
          practical, real-world contexts by means of internships or co-operative
          education experiences, as well as through course projects.
        </p>
      </section>
      <section className="choose aboutUs-section">
        ...
        <ul className="services-ul">
          ...
          <li className="services-li">
            Join a network of alumni who hold positions in leading companies
            such as Facebook, Google, Lockheed Martin, Microsoft and others
          </li>
        </ul>
      </section>
