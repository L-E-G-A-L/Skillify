...
import './InstructorDiscussion.css'; // Import your CSS file here
  ...
  return (
    <div>
      ...
      <nav className='id-nav'>
        <ul className='id-ul'>
          <li className='id-li'><a href="#" className='id-a'>Student</a></li>
          <li className='id-li'><a href="#" className='id-a'>QA Officer</a></li>
          <li className='id-li'><a href="#" className='id-a'>Admin</a></li>
          <li className='id-li'><a href="#" className='id-a'>Program Coordinator</a></li>
        </ul>
      </nav>
      <section className='id-section' id="students">
        ...
        <div className="instructorDiscussion-discussion">
          ...
          <label className='id-label' for="discussion1">Discussion 1</label>
        ...
        <div className="instructorDiscussion-discussion">
          ...
          <label className='id-label' for="discussion2">Discussion 2</label>
          <div className="instructorDiscussion-discussion-content">
